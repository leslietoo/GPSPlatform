...
namespace GPS.JT808PubSubToRabbitMQ.Producer
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            JT808_UnificationSend_Producer jT808_UnificationSend_Producer = new JT808_UnificationSend_Producer("host=172.16.19.120");
            ...
            Parallel.Invoke(
                () => {
                    ...
                    while (i > 0)
                    {
                        ...
                        Console.WriteLine("0X0200_Producer"+i.ToString());
                        i--;
                        Thread.Sleep(5000);
                    }
                }
                ...
                //    while (i > 0)
                //    {
                //        jT808_UnificationSend_Producer.ProduceAsync("013812345678", bytes);
                //        Console.WriteLine("jT808_UnificationSend_Producer"+i.ToString());
                //        i--;
                //        Thread.Sleep(5000);
                //    }
                //}
