...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    ...
    {
        public JT808_0x8900 Deserialize(ReadOnlySpan<byte> bytes, int offset, IJT808FormatterResolver formatterResolver, out int readSize)
        {
            offset = 0;
            ...
            {
                jT808_0X8900.JT808_0X8900_BodyBase = JT808FormatterResolverExtensions.JT808DynamicDeserialize(formatterResolver.GetFormatterDynamic(type), bytes.Slice(offset), offset, formatterResolver, out readSize);
            }
            readSize = offset;
            return jT808_0X8900;
        }

        public int Serialize(ref byte[] bytes, int offset, JT808_0x8900 value, IJT808FormatterResolver formatterResolver)
        {
            offset += JT808BinaryExtensions.WriteLittle(ref bytes, offset, value.PassthroughType);
            object obj = formatterResolver.GetFormatterDynamic(value.JT808_0X8900_BodyBase.GetType());
